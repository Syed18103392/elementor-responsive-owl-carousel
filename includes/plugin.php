...
final class Plugin {
	...
	public function i18n() {
		load_plugin_textdomain( 'gf-owl-carousel-elementor' );
	}
	...
	public function init() {
		require_once( GF_OWL_CAROUSEL_PLUGIN_PATH . '/includes/functions.php' );
	...
	public function register_widgets( $widgets_manager ) {
		require_once GF_OWL_CAROUSEL_PLUGIN_PATH . '/includes/widgets/owl-carousel.php';
