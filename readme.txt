...
2. Unzip downloaded archive and upload `gf-owl-carousel-elementor` folder under `/wp-content/plugins/` directory (resulted plugin path should be `/wp-content/plugins/gf-owl-carousel-elementor`);
...
1. **How to Use** - Carousel Customization
2. **Demo** - Basic
3. **Demo** - Image Only
4. **Demo** - Testimonial One
5. **Demo** - Testimonial Two
6. **Demo** - Testimonial Three
7. **Demo** - Testimonial Four
8. **Demo** - Team One
9. **Demo** - Team Two
